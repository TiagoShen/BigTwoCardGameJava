...
public class CardList implements Serializable {
	 ...
	 * @return the card that is removed from the list
	 */
	 ...
	 * is present. If the list does not contain the card, it is unchanged.
	 * Returns true if this list contained the specified card (or equivalently,
	 * if this list changed as a result of the call).
	 * 
	 * @param card
	 *            the card to be removed from this list, if present
	 * @return true if this list contained the specified card
	 */
	 ...
	 * @return true if this list contains the specified card
	 */
	 ...
	 * 
	 * @return true if this list contains no cards
	 */
